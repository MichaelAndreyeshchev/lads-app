export default {
  ...
  'Configure your AWS credentials to enable cloud services integration.': 'Configure your AWS credentials to enable cloud services integration.',
  ...
  '(Optional)': '(Optional)',
  'Enter session token for temporary credentials': 'Enter session token for temporary credentials',
  'Credentials are stored securely in your browser': 'Credentials are stored securely in your browser',
  'Save Credentials': 'Save Credentials',
  'Saving...': 'Saving...',
  'Test Connection': 'Test Connection',
  'Testing...': 'Testing...',
  'Clear Stored Credentials': 'Clear Stored Credentials',
  'AWS credentials saved successfully': 'AWS credentials saved successfully',
  'Please enter new credentials': 'Please enter new credentials',
  'Failed to save credentials': 'Failed to save credentials',
  'Connection successful! Your AWS credentials are valid.': 'Connection successful! Your AWS credentials are valid.',
  ...
  'Are you sure you want to clear your stored AWS credentials?': 'Are you sure you want to clear your stored AWS credentials?',
  'AWS credentials cleared': 'AWS credentials cleared',
}    