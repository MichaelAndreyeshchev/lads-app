...
async def lifespan(app: FastAPI):
    ...
    logger.info("Application startup - LADS AI Agent initializing")
    ...
    try:
        ...
        logger.info("Application shutdown - LADS AI Agent terminating")
...
app = FastAPI(title="LADS AI Agent", lifespan=lifespan)
